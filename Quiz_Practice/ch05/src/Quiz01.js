...
function Quiz01() {
   ...
   const onChangeRemove = (e) => setRemoveDept(e.target.value)
   ...
   return (
      <>
         ...
         <br />
         <input type="text" value={RemoveDept} onChange={onChangeRemove} />
         <button onClick={() => onRemove(RemoveDept)}>부서별 삭제</button>
         <br />
         <ul>{employeeList}</ul>
      </>
   )
